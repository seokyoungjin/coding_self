...
define('G5_MYSQL_USER', 'mkyu');
define('G5_MYSQL_PASSWORD', 'korea2397!');
define('G5_MYSQL_DB', 'mkyu');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '0edd7a51b31cd4e375738aed16a646b9'); // 토큰 암호화에 사용할 키
